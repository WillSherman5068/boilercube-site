  ...
  <div className="team-grid">
    {people.map((p, idx) => {
      ...
      return (
        ...
        >
          <div className="headshot" style={{ marginBottom: 14 }}>
            Headshot
          </div>
      ...
      <section className="section big-section">
        ...
        <p className="sub" style={{ maxWidth: 980 }}>
          Add photos of the full group, build sessions, outreach events, and competition travel.
        </p>

        <div className="photo-grid" style={{ marginTop: 16 }}>
          <div className="photo-tile">Group photo placeholder</div>
          <div className="photo-tile">Build / demo photo placeholder</div>
          <div className="photo-tile">Outreach / event photo placeholder</div>
          <div className="photo-tile">Competition photo placeholder</div>
        </div>
      </section>
